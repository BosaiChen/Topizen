...
$config['autologin_cookie_name'] = 'tp_autologin_cookie';
$config['autologin_cookie_life'] = 60*60*24*7*4;//by default in 4 weeks
...
| 'firstname_min_length'= Min length of user's firstname.
| 'firstname_max_length'= Max length of user's firstname.
| 'lastname_min_length' = Min length of user's lastname.
| 'lastname_max_length' = Max length of user's lastname.
...
$config['firstname_min_length'] = 4;
$config['firstname_max_length'] = 20;
$config['lastname_min_length'] = 4;
